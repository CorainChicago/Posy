  ...
  render: function() {
    return (
      React.DOM.div({className: "comment"}, 
        React.DOM.p({className: "comment-content"}, 
          React.DOM.span({className: "comment-author"}, this.props.author, " says: "), 
          this.props.content
        )
      )
    )
...
var LocationDisplay = React.createClass({displayName: 'LocationDisplay',
  getInitialState: function() {
  ...
  render: function() {  
      return (
        React.DOM.div({id: "location-container"}, 
  ...
  render: function() {
    ...
    return (
      React.DOM.div({className: "post"}, 
        React.DOM.div({className: "post-content"}, 
          React.DOM.p({className: "location"}, "at ", this.props.location), 
          React.DOM.p({className: "post-description"}, this.props.desc), 
          React.DOM.p({className: "content"}, this.props.content)
        ), 
        ...
        React.DOM.a({href: "#", className: "report-post", onClick: this.handleFlaggingClick}, " Report "))
      )
    );
  }
});
...
var PostForm = React.createClass({displayName: 'PostForm',
  ...
  render: function() {
    return (
      React.DOM.form({'accept-charset': "UTF-8", action: postsPath, id: "post-form", method: "post", ref: "postForm", onSubmit: this.props.handlePostSubmit}, 
        React.DOM.div({className: "post-form-select"}, 
          React.DOM.label({for: "post_gender"}, "Gender"), React.DOM.br(null), 
          React.DOM.div({className: "post-form-select-background"}, 
            React.DOM.select({id: "post_gender", name: "post[gender]", ref: "genderSelect"}, 
              React.DOM.option({value: ""}), 
              React.DOM.option({value: "Male"}, "Male"), 
              React.DOM.option({value: "Female"}, "Female"), 
        ...
        React.DOM.div({className: "post-form-select"}, 
          ...
          React.DOM.div({className: "post-form-select-background", id: "post_hair_background"}, 
            React.DOM.select({id: "post_hair", name: "post[hair]"}, 
              ...
              React.DOM.option({value: "Blonde"}, "Blonde"), 
        ...
        React.DOM.label({for: "post_spotted_at"}, "Location ", React.DOM.span({id: "location-requirement"}, "(required)")), 
        React.DOM.input({id: "post_spotted_at", name: "post[spotted_at]", type: "text"}), React.DOM.br(null), 

        React.DOM.label({for: "post_content"}, "Message ", React.DOM.span({id: "content-requirement"}, "(required)")), 
        React.DOM.textarea({id: "post_content", name: "post[content]", rows: "4", ref: "contentField"}), React.DOM.br(null), 

        React.DOM.input({type: "submit", value: "Submit!", ref: "submitButton"}), 
        React.DOM.a({id: "post-form-cancel", href: "#", onClick: this.props.cancel}, "Cancel")
      )
    )
  }
})
...
PostList = React.createClass({displayName: 'PostList',
  render: function() {
      ...
      React.DOM.div({id: "sidebar"}, 
        React.DOM.div({id: "sidebar-container"}, 
          React.DOM.div({id: "sidebar-logo"}, 
            ...
            React.DOM.h3({id: "logo-desc"}, "For those around you")
          ), 
