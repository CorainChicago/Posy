...
var LocationPosts = React.createClass({displayName: 'LocationPosts',
  getInitialState: function() {
    return { posts: [] };
  },
  ...
  render: function() {
    ...
    return (
      React.DOM.div({id: "react-location-posts-container"}, 
        postNodes 
      )
    );
  }
...
var Post = React.createClass({displayName: 'Post',
  ...
  render: function() {
    return (
      React.DOM.div({className: "post", ref: "postContainer"}, 
        React.DOM.h4({className: "post-location"}, "at ",  this.props.location), 
        React.DOM.h5({className: "post-description"},  this.props.description), 
        React.DOM.p({className: "post-content"},  this.props.content), 
      
        CommentList({comments: this.props.comments, postId: this.props.key, ref: "list"}), 
        React.DOM.p({className: "post-links"}, 
          this.props.age, " ago |",  
          React.DOM.a({className: "post-links-comment", href: "#", onClick: this.handleCommentClick}, "Comment"), " |",  
          React.DOM.a({className: "post-links-report", href: "#", onClick: this.handleFlaggingClick}, "Report")
        )
      )
    )
  }
...
var Comment = React.createClass({displayName: 'Comment',
  render: function() {
    return (
      React.DOM.p({className: "comment"}, 
        React.DOM.span({className: "comment-author"}, this.props.author, " says:"), " ", this.props.content
      )
    );
  }
});
...
var CommentForm = React.createClass({displayName: 'CommentForm',
  ...
  render: function() {
    return (
      React.DOM.form({className: "new-comment", action:  this.postPath(), method: "POST"}, 
